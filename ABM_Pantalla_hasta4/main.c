...
int main()
{
    ...
    while(opcion!=6)
    {
        getIntInRange(&opcion,"\n1)Alta de pantalla\n2)Modificar datos de pantalla\n3)Baja de pantalla\n"
                      "4)Contratar Publicidad\n5)Mostrar Pantallas\n6)Salir\n8)listar contrataciones\n9)contrataciones menor a 10\n10)ordenar x dias de menor a mayor\n    INGRESE OPCION: ","ERROR\n",1,10,3);
        switch(opcion)
    {
            case 1:
            {
            ...
            case 9:
                    {
                        printpublicidaddiasmenores(Marketing,visores,LEN_LISTA,LEN_LISTA,10);
            ...
            case 10:
            {    pub_printContrataciones(Marketing,visores,LEN_LISTA,LEN_LISTA);
                 pan_orderByday(Marketing,LEN_LISTA);
                 pub_printContrataciones(Marketing,visores,LEN_LISTA,LEN_LISTA);
                 break;
            }
